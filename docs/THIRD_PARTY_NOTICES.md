...
| FloatLib | Configurable executable scalars, reference semantics, generic rounding theory, and arithmetic refinement proofs. | Source project: `lean-dojo/FloatLib`, pinned to `40301cd44f253a4ac6ccd34a0eb6c221e185e25c`. MIT licensed; its license is distributed with the dependency. |
