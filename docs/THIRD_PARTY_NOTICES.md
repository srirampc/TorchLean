...
| FloatLib | Configurable executable scalars, reference semantics, generic rounding theory, and arithmetic refinement proofs. | Source project: `lean-dojo/FloatLib`, pinned to `52ab504bfcd8e5395b29a4f64b617b401e5d16ac`. MIT licensed; its license is distributed with the dependency. |
